...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "file.importing": "Importing {count} item(s)…",
    "file.importSuccess": "Imported {count} item(s)",
    "file.importFailed": "Import failed: {error}",
    "file.delete": "Delete",
  ...
  zh: {
    ...
    "file.importing": "正在导入 {count} 个项目…",
    "file.importSuccess": "已导入 {count} 个项目",
    "file.importFailed": "导入失败：{error}",
    "file.delete": "删除",
